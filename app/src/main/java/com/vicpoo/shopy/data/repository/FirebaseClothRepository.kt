    ...
    override fun observeClothesBySeller(sellerId: String): Flow<List<Cloth>> = callbackFlow {
        val listener = object : ValueEventListener {
            ...
            override fun onCancelled(error: DatabaseError) {
                // ✅ CORREGIDO: Enviar lista vacía en lugar de cerrar con excepción
                android.util.Log.e("FirebaseClothRepo", "Error en listener: ${error.message}")
        ...
        awaitClose {
            try {
                ...
                android.util.Log.e("FirebaseClothRepo", "Error al remover listener", e)
            }
        }
    }
